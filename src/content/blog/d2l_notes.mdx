---
title: "D2l.ai notes"
description: "Dense notes from a wonderfully comprehensive deep learning resource"
featured: true
ready: true
seriesId: home
orderInSeries: 2
...
These are my personal, raw notes from studying this book.\
My aim is to condense the most interesting information into a single page for easier access. I’ll keep adding chapters as I keep studying.\
Some parts are rephrased by me, some are copied from the website, and some come from external resources I used to clarify concepts I was unsure about.\
To go deeper, visit their excellent [website](https://d2l.ai).
