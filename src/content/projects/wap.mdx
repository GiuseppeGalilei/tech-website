...
We were browsing an article about **hunger**, upon clicking on the WAP extension icon we receive almost immediately a list of **NGOs working on hunger issues**.
Selecting one of them we could easily begin a **donation** process.
